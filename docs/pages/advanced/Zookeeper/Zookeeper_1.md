...
### **1.1 文件系统**
![0](./Zookeeper_1.assets/42364.png)
...
![0](./Zookeeper_1.assets/42363.png)
...
![0](./Zookeeper_1.assets/42365.png)
...
![0](./Zookeeper_1.assets/42366.png)

![0](./Zookeeper_1.assets/44150.png)

### **3. 负载均衡**

![0](./Zookeeper_1.assets/42368.png)
...
![0](./Zookeeper_1.assets/42369.png)
...
![0](./Zookeeper_1.assets/42370.png)
...
2. 就是动态Master选举。这就要用到 **EPHEMERAL_SEQUENTIAL**类型节点的特性了，这样每个节点会自动被编号。允许所有请求都能够创建成功，但是得有个创建顺序，每次选取序列号**最小**的那个机器作为**Master** 。
...
![0](./Zookeeper_1.assets/42371.png)
...
2. **xid**是一个依次递增的事务编号。数值越大说明数据越新，所有 proposal（提议）在被提出的时候加上了**zxid**，然后会依据数据库的[**两阶段过程**]，首先会向其他的 server 发出事务执行请求，如果超过半数的机器都能执行并且能够成功，那么就会开始执行。
...
![0](./Zookeeper_1.assets/42372.png)
...
![0](./Zookeeper_1.assets/42373.png)
...
建议先看下  [**浅谈大数据中的2PC、3PC、Paxos、Raft、ZAB**] (java进阶>设计>) ，不然可能看的吃力。
...
![0](./Zookeeper_1.assets/49047.png)
![0](./Zookeeper_1.assets/42374.png)
...
![0](./Zookeeper_1.assets/49053.png)
...
![0](./Zookeeper_1.assets/42375.png)
...
processOn流程图(精华)：[zookeeper脑图](https://www.processon.com/view/link/627b13bdf346fb18e7cf2f76)